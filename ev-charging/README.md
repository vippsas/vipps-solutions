...
6. If you are set up in Vipps' systems with the correct MCC-code for EV charging(5552) we will automatically send a push notification to the user with the captured amount.
